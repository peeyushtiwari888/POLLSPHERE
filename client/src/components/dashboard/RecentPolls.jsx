  ...
  return (
    <div className="bg-white dark:bg-zinc-900 rounded-2xl border border-gray-100 dark:border-zinc-800 shadow-sm overflow-hidden flex flex-col h-full">
      ...
      <div className="px-6 py-5 border-b border-gray-100 dark:border-zinc-800 flex justify-between items-center">
        ...
        <button className="text-sm font-medium text-orange-600 dark:text-orange-500 hover:text-orange-700 dark:hover:text-orange-400 transition-colors">
          View All &rarr;
        </button>
      </div>
          ...
          <tbody className="divide-y divide-gray-100 dark:divide-zinc-800">
            {polls.length === 0 ? (
              ...
              polls.map((poll) => {
                ...
                return (
                  <tr key={poll._id || poll.id} className="hover:bg-gray-50/50 dark:hover:bg-zinc-800/30 transition-colors group">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                      <div className="flex items-center justify-end gap-2 opacity-100 sm:opacity-0 sm:group-hover:opacity-100 transition-opacity">
                        ...
                        {/* View */}
                        <button className="p-1.5 text-gray-400 hover:text-blue-600 hover:bg-blue-50 dark:hover:bg-blue-500/10 rounded-lg transition-colors" title="View Poll">
                          <Eye className="w-4 h-4" />
                        </button>
                        
                        {/* Edit */}
                        <button className="p-1.5 text-gray-400 hover:text-orange-600 hover:bg-orange-50 dark:hover:bg-orange-500/10 rounded-lg transition-colors" title="Edit Poll">
                          <PenLine className="w-4 h-4" />
                        </button>
                        
                        {/* Analytics */}
                        <button className="p-1.5 text-gray-400 hover:text-emerald-600 hover:bg-emerald-50 dark:hover:bg-emerald-500/10 rounded-lg transition-colors" title="View Analytics">
                          <BarChart2 className="w-4 h-4" />
                        </button>
                        
                        {/* Share */}
                        <button className="p-1.5 text-gray-400 hover:text-purple-600 hover:bg-purple-50 dark:hover:bg-purple-500/10 rounded-lg transition-colors" title="Share Poll">
                          <Share2 className="w-4 h-4" />
                        </button>
                        
                        {/* Delete */}
                        <button className="p-1.5 text-gray-400 hover:text-red-600 hover:bg-red-50 dark:hover:bg-red-500/10 rounded-lg transition-colors" title="Delete Poll">
