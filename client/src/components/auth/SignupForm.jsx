 ...
 * Includes a custom refinement to ensure password and confirmPassword match.
 */
...
const SignupForm = () => {
  ...
  const onSubmit = async (data) => {
    try {
      // Call the signup API endpoint directly
  ...
  return (
    // Wrap everything in the reusable AuthCard layout
    <AuthCard>
